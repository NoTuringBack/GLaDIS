...
/**
 * Created by rosalie on 02/12/16.
 */

public class BlagueRequest extends RequestType {

    Context context;
    String fileName = "SimpleTypeGranules.json";

    public BlagueRequest(Context c)
    {
        super();
        context = c;
    }
    ...
    public ConvMessage respondTo(String entry, Conversation conv)
    {
        ...
        List<Granule> granules = GranuleParser.parseGranulesFromFile("BlagueTypeGranules.json", this.context);
